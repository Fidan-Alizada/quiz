...
import { getQuestions, saveResult } from "./firebase.js";
...
function showModal() {
  ...
  startQuizBtn.addEventListener("click", () => {
    ...
    if (adminName !== "") {
      userName = adminName; // user's name
      nameModal.style.display = "none";
      startGame();
    } else {
...
function endGame() {
  ...
  resultsElement.innerHTML = `<p>${userName}, your score: ${score} out of ${shuffledQuestions.length}</p>`;
